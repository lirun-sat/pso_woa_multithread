...
namespace openGJK{
  ...
  gkFloat determinant(const gkFloat *p, const gkFloat *q, const gkFloat *r) {
    return p[0] * ((q[1] * r[2]) - (r[1] * q[2])) - p[1] * (q[0] * r[2] - r[0] * q[2]) +
          p[2] * (q[0] * r[1] - r[0] * q[1]);
  }

  void crossProduct(const gkFloat *a, const gkFloat *b, gkFloat *c) {
    c[0] = a[1] * b[2] - a[2] * b[1];
    c[1] = a[2] * b[0] - a[0] * b[2];
    c[2] = a[0] * b[1] - a[1] * b[0];
  }

  void projectOnLine(const gkFloat *p, const gkFloat *q, gkFloat *v) {
    gkFloat pq[3];
    gkFloat tmp;
    pq[0] = p[0] - q[0];
    pq[1] = p[1] - q[1];
  ...
  void projectOnPlane(const gkFloat *p, const gkFloat *q, const gkFloat *r, gkFloat *v) {
  ...
  int hff1(const gkFloat *p, const gkFloat *q) {
    gkFloat tmp = 0;
  ...
  int hff2(const gkFloat *p, const gkFloat *q, const gkFloat *r) {
    gkFloat ntmp[3];
    gkFloat n[3], pq[3], pr[3];
    gkFloat tmp = 0;
  ...
  int hff3(const gkFloat *p, const gkFloat *q, const gkFloat *r) {
    gkFloat n[3], pq[3], pr[3];
    gkFloat tmp = 0;
  ...
  void S1D(gkSimplex *s, gkFloat *v) {
  ...
  void S2D(gkSimplex *s, gkFloat *v) {
  ...
  void S3D(gkSimplex *s, gkFloat *v) {
  ...
  void support(gkPolytope *body, const gkFloat *v) {
    gkFloat s, maxs;
    gkFloat *vrt;
    int better = -1;
  ...
  void subalgorithm(gkSimplex *s, gkFloat *v) {
    switch (s->nvrtx) {
      case 4:
        S3D(s, v);
        break;
